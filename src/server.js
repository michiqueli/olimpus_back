...
server.use((err, req, res, next) => { // este middleware captura los errores del servidor e imprime los detalles por consola, envia respuesta de error a cliente. es opcional.
